...
ventanaProveedores::ventanaProveedores(FarmaSystem::ListaProveedores* listaProv, FarmaSystem::ListaMedicamentos* listaMed, QWidget *parent)
    : QDialog(parent)
...
void ventanaProveedores::on_btnGuardar_clicked()
{
    ...
    if(losProveedores->buscarPorId(id) != nullptr) {
...
void ventanaProveedores::on_btnActualizar_clicked()
{
    ...
    FarmaSystem::Proveedor* prov = losProveedores->buscarPorId(id);
...
void ventanaProveedores::on_btnEliminar_clicked()
{
    ...
    for (int i = 0; i < losMedicamentos->cantidad(); ++i) {
        FarmaSystem::Medicamento* med = losMedicamentos->obtener(i);
