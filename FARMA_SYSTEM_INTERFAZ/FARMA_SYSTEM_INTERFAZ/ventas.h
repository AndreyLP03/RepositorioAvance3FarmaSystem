...
public:
    ...
    explicit Ventas(FarmaSystem::ListaMedicamentos* listaMed,
                    FarmaSystem::ListaClientes* listaCli,
                    FarmaSystem::ListaCircularVentas* listaVen,
...
private:
    ...
    FarmaSystem::ListaMedicamentos* miListaMed;
    FarmaSystem::ListaClientes* miListaCli;
    FarmaSystem::ListaCircularVentas* miListaVen;
